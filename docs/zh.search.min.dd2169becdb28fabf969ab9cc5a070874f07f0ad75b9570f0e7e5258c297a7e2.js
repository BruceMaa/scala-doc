...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.203934d734a0416dc058c999e7d887175775063685f9dd50f881138663066aab.js',function(){input.required=false;search();});}
