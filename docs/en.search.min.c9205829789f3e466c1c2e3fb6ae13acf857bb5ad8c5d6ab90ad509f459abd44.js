...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f960d7f649b6e155b8e2869c7a3d4e550037ca3ce009b298251a9ca7fc17ae34.js',function(){input.required=false;search();});}
